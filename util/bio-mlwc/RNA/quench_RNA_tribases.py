...
# run it from the bio-mlwc/RNA directory
...
if __name__ == "__main__":
	...
	file_names = ["../RNA/template_files/{}/rna_a{}a".format(b, b.lower()) for b in bases]
	...
	for file_name in file_names:
		...
		print "\nrunning quench"
		command = "srun -ppdebug -n195 {}/bin/mgmol-pel -c ../RNA/{} -i {}.xyz > {}.out".format(maindir, config_file_name, file_name, file_name)
		print command
		os.system(command)
